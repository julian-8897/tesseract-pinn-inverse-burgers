...
The calibration story (SBC, TARP coverage, contraction) lives in the diagnostics
CLI rather than inline; `make plot-sbi` regenerates those panels. The headline
number stays the same: joint coverage holds, and the ν marginal is a little too
narrow.
